...
end key_expansion_192;


architecture behave of key_expansion_192 is
...
component demux1to4 is
	...
	type state_type is (start, idle, shift_words, init_sub, sub_bytes_0, sub_bytes_1, sub_bytes_2, sub_bytes_3, end_round);
	signal state   : state_type;
	
	type word is array (3 downto 0) of std_logic_vector (7 downto 0);
	signal w0, w1, w2, w3, w4, w5, w_aux, out_mux0, out_mux1, out_mux2, out_mux3, out_mux4, out_mux5, w_aux_in, rcon: word;
...
--	constant key : std_logic_vector (191 downto 0):= X"8E73B0F7DA0E6452C810F32B809079E562F8EAD2522C6B7B";
...
--						rcon(3)<= X"1B";
	...
	-----------manejo la direccion para la memoria a la salida
	process (counter_aux, s_data_valid, clk, reset_ram)
	begin
		...
		if reset_ram = '1' then
			s_ram_addr <= 0;
		elsif rising_edge(clk) and counter_aux =3 then
			s_ram_addr <= s_ram_addr + 1;
		end if;
...
mux_w0: mux2to1_32 port map (sel=>sel_mux, d0=>key(191 downto 160), d1=>w1(3) & w1(2) & w1(1) & w1(0), y(31 downto 24)=>out_mux0(3), y(23 downto 16)=>out_mux0(2), y(15 downto 8)=>out_mux0(1), y(7 downto 0)=>out_mux0(0));
mux_w1: mux2to1_32 port map (sel=>sel_mux, d0=>key(159 downto 128), d1=>w2(3) & w2(2) & w2(1) & w2(0), y(31 downto 24)=>out_mux1(3), y(23 downto 16)=>out_mux1(2), y(15 downto 8)=>out_mux1(1), y(7 downto 0)=>out_mux1(0));
mux_w2: mux2to1_32 port map (sel=>sel_mux, d0=>key(127 downto 96), d1=>w3(3) & w3(2) & w3(1) & w3(0), y(31 downto 24)=>out_mux2(3), y(23 downto 16)=>out_mux2(2), y(15 downto 8)=>out_mux2(1), y(7 downto 0)=>out_mux2(0));
mux_w3: mux2to1_32 port map (sel=>sel_mux, d0=>key(95 downto 64), d1=>w4(3) & w4(2) & w4(1) & w4(0), y(31 downto 24)=>out_mux3(3), y(23 downto 16)=>out_mux3(2), y(15 downto 8)=>out_mux3(1), y(7 downto 0)=>out_mux3(0));
mux_w4: mux2to1_32 port map (sel=>sel_mux, d0=>key(63 downto 32), d1=>w5(3) & w5(2) & w5(1) & w5(0), y(31 downto 24)=>out_mux4(3), y(23 downto 16)=>out_mux4(2), y(15 downto 8)=>out_mux4(1), y(7 downto 0)=>out_mux4(0));
mux_w5: mux2to1_32 port map (sel=>sel_mux, d0=>key(31 downto 0), d1=>out_mux_aux, y(31 downto 24)=>out_mux5(3), y(23 downto 16)=>out_mux5(2), y(15 downto 8)=>out_mux5(1), y(7 downto 0)=>out_mux5(0));

mux_aux: mux2to1_32 port map (sel=>sel_mux_aux, d0=>(w5(3) xor w0(3)) & (w5(2) xor w0(2)) & (w5(1) xor w0(1)) & (w5(0) xor w0(0)), d1=> (w_aux(3) xor rcon(3) xor w0(3)) & (w_aux(2) xor rcon(2) xor w0(2)) & (w_aux(1) xor rcon(1) xor w0(1)) & (w_aux(0) xor rcon(0) xor w0(0)), y=> out_mux_aux);	

-- hago rotword cambiando el orden en que los bytes de w3 entran al mux
sbox_mux: mux4to1_8 port map (sel=>sel_addr_sbox, d0=>w5(3), d1=>w5(0), d2=>w5(1), d3=>w5(2), y=> addr_sbox );
