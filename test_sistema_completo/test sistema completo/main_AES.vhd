...
--					state <= SUB_BYTES;	
				...
				when INC_ROUND =>
					enable_sbox <= '1';
					reg_text <= (mixed_text(0) & mixed_text(1) & mixed_text(2) & mixed_text(3) & mixed_text(4) & mixed_text(5) & mixed_text(6) & mixed_text(7) & mixed_text(8) & mixed_text(9) & mixed_text(10) & mixed_text(11) & mixed_text(12) & mixed_text(13) & mixed_text(14) & mixed_text(15)) xor round_key;
					round <= round +1;
					state <= SUB_BYTES;
					if round < Nr-1 then
						last_round <= '0';
				...
				when DONE =>
--					done_o <= '1';
					ciphertext_out <= (sub_text(0) & sub_text(5) & sub_text(10) & sub_text(15) & sub_text(4) & sub_text(9) & sub_text(14) & sub_text(3) & sub_text(8) & sub_text(13) & sub_text(2) & sub_text(7) & sub_text(12) & sub_text(1) & sub_text(6) & sub_text(11)) xor round_key;
					state <= IDLE;
					reg_out <= '1';
